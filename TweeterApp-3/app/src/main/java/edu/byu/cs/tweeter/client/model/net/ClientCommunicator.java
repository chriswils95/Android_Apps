        ...
        try {
            ...
            switch (connection.getResponseCode()) {
                case HttpURLConnection.HTTP_OK:
                    String timeout = "BadRequest";
                    String timeout1 = "400";
                    String responseString = getResponse(connection.getInputStream());
                    if(responseString.indexOf(timeout) > 0 || responseString.indexOf(timeout1) > 0){

                        ErrorResponse errorResponse = new ErrorResponse();
                        errorResponse.errorType = timeout;
                        throw new TweeterRequestException(timeout, errorResponse.errorType, errorResponse.stackTrace);
                    }
